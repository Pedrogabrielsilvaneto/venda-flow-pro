(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_mongoose_lib_model_7934c3b1.js",
"[project]/node_modules/mongoose/lib/model.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const DocumentNotFoundError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/notFound.js [middleware-edge] (ecmascript)");
...
const ObjectParameterError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/objectParameter.js [middleware-edge] (ecmascript)");
const OverwriteModelError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/overwriteModel.js [middleware-edge] (ecmascript)");
const Query = __turbopack_context__.r("[project]/node_modules/mongoose/lib/query.js [middleware-edge] (ecmascript)");
const SaveOptions = __turbopack_context__.r("[project]/node_modules/mongoose/lib/options/saveOptions.js [middleware-edge] (ecmascript)");
...
const VersionError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/version.js [middleware-edge] (ecmascript)");
const ParallelSaveError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/parallelSave.js [middleware-edge] (ecmascript)");
const applyDefaultsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyDefaults.js [middleware-edge] (ecmascript)");
const isInPathsToSave = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/isInPathsToSave.js [middleware-edge] (ecmascript)");
const applyDefaultsToPOJO = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyDefaultsToPOJO.js [middleware-edge] (ecmascript)");
...
const applyHooks = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyHooks.js [middleware-edge] (ecmascript)");
const applyMethods = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyMethods.js [middleware-edge] (ecmascript)");
const applyProjection = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/projection/applyProjection.js [middleware-edge] (ecmascript)");
const applyReadConcern = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/applyReadConcern.js [middleware-edge] (ecmascript)");
const applySchemaCollation = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/applySchemaCollation.js [middleware-edge] (ecmascript)");
const applyStaticHooks = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyStaticHooks.js [middleware-edge] (ecmascript)");
const applyStatics = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/applyStatics.js [middleware-edge] (ecmascript)");
const applyTimestampsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyTimestamps.js [middleware-edge] (ecmascript)");
const applyWriteConcern = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/applyWriteConcern.js [middleware-edge] (ecmascript)");
const applyVirtualsHelper = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/applyVirtuals.js [middleware-edge] (ecmascript)");
const assignVals = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/assignVals.js [middleware-edge] (ecmascript)");
...
const createPopulateQueryFilter = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/createPopulateQueryFilter.js [middleware-edge] (ecmascript)");
...
const each = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/each.js [middleware-edge] (ecmascript)");
...
const getModelsMapForPopulate = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/getModelsMapForPopulate.js [middleware-edge] (ecmascript)");
...
const isDefaultIdIndex = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isDefaultIdIndex.js [middleware-edge] (ecmascript)");
const isIndexEqual = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isIndexEqual.js [middleware-edge] (ecmascript)");
...
const isTimeseriesIndex = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/isTimeseriesIndex.js [middleware-edge] (ecmascript)");
const { getRelatedDBIndexes, getRelatedSchemaIndexes } = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/indexes/getRelatedIndexes.js [middleware-edge] (ecmascript)");
...
const parallelLimit = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/parallelLimit.js [middleware-edge] (ecmascript)");
...
const pushNestedArrayPaths = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/model/pushNestedArrayPaths.js [middleware-edge] (ecmascript)");
const removeDeselectedForeignField = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/populate/removeDeselectedForeignField.js [middleware-edge] (ecmascript)");
...
const minimize = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/minimize.js [middleware-edge] (ecmascript)");
const MongooseBulkSaveIncompleteError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/bulkSaveIncompleteError.js [middleware-edge] (ecmascript)");
...
const { arrayAtomicsBackupSymbol, arrayAtomicsSymbol, modelSymbol } = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/symbols.js [middleware-edge] (ecmascript)");
 ...
 */ Model.hydrate = function(obj, projection, options) {
    ...
    const document = __turbopack_context__.r("[project]/node_modules/mongoose/lib/queryHelpers.js [middleware-edge] (ecmascript)").createModel(this, obj, projection, projection, options);
...
//# sourceMappingURL=node_modules_mongoose_lib_model_7934c3b1.js.map