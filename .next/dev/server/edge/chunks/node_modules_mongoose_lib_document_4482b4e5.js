(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_mongoose_lib_document_4482b4e5.js",
"[project]/node_modules/mongoose/lib/document.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
/*!
 * Module dependencies.
 */ const DivergentArrayError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/divergentArray.js [middleware-edge] (ecmascript)");
const EventEmitter = __turbopack_context__.r("[externals]/node:events [external] (node:events, cjs)").EventEmitter;
const InternalCache = __turbopack_context__.r("[project]/node_modules/mongoose/lib/internal.js [middleware-edge] (ecmascript)");
...
const MixedSchema = __turbopack_context__.r("[project]/node_modules/mongoose/lib/schema/mixed.js [middleware-edge] (ecmascript)");
const ModifiedPathsSnapshot = __turbopack_context__.r("[project]/node_modules/mongoose/lib/modifiedPathsSnapshot.js [middleware-edge] (ecmascript)");
...
const ParallelValidateError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/parallelValidate.js [middleware-edge] (ecmascript)");
...
const ValidatorError = __turbopack_context__.r("[project]/node_modules/mongoose/lib/error/validator.js [middleware-edge] (ecmascript)");
const $__hasIncludedChildren = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/projection/hasIncludedChildren.js [middleware-edge] (ecmascript)");
...
const compile = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/compile.js [middleware-edge] (ecmascript)").compile;
...
const firstKey = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/firstKey.js [middleware-edge] (ecmascript)");
...
const getEmbeddedDiscriminatorPath = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/getEmbeddedDiscriminatorPath.js [middleware-edge] (ecmascript)");
const getKeysInSchemaOrder = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/getKeysInSchemaOrder.js [middleware-edge] (ecmascript)");
const getSubdocumentStrictValue = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/schema/getSubdocumentStrictValue.js [middleware-edge] (ecmascript)");
...
const inspect = __turbopack_context__.r("[externals]/node:util [external] (node:util, cjs)").inspect;
...
const queryhelpers = __turbopack_context__.r("[project]/node_modules/mongoose/lib/queryHelpers.js [middleware-edge] (ecmascript)");
...
const documentModifiedPaths = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/symbols.js [middleware-edge] (ecmascript)").documentModifiedPaths;
...
const getDeepestSubdocumentForPath = __turbopack_context__.r("[project]/node_modules/mongoose/lib/helpers/document/getDeepestSubdocumentForPath.js [middleware-edge] (ecmascript)");
 ...
 */ Document.prototype.$__set = function(pathToMark, path, options, constructing, parts, schema, val, priorVal) {
    Embedded = Embedded || __turbopack_context__.r("[project]/node_modules/mongoose/lib/types/arraySubdocument.js [middleware-edge] (ecmascript)");
    ...
    if (shouldModify) {
        ...
        MongooseArray || (MongooseArray = __turbopack_context__.r("[project]/node_modules/mongoose/lib/types/array/index.js [middleware-edge] (ecmascript)"));
 ...
 */ Document.prototype.$__getArrayPathsToValidate = function() {
    DocumentArray || (DocumentArray = __turbopack_context__.r("[project]/node_modules/mongoose/lib/types/documentArray/index.js [middleware-edge] (ecmascript)"));
 ...
 */ Document.prototype.$__delta = function $__delta(pathsToSave, pathsToSaveSet) {
    ...
    if (optimisticConcurrency) {
        if (Array.isArray(optimisticConcurrency)) {
            ...
            const hasRelevantModPaths = pathsToSave == null ? modPaths.find((path)=>optCon.has(path)) : modPaths.find((path)=>optCon.has(path) && isInPathsToSave(path, pathsToSaveSet, pathsToSave));
            ...
            const modPaths = this.modifiedPaths();
            const hasRelevantModPaths = pathsToSave == null ? modPaths.find((path)=>!excluded.has(path)) : modPaths.find((path)=>!excluded.has(path) && isInPathsToSave(path, pathsToSaveSet, pathsToSave));
            if (hasRelevantModPaths) {
                this.$__.version = dirty.length ? VERSION_ALL : VERSION_WHERE;
            }
        } else {
    ...
    for(; d < len; ++d){
        ...
        } else if (value[MongooseBuffer.pathSymbol] && __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(value)) {
            // MongooseBuffer
...
//# sourceMappingURL=node_modules_mongoose_lib_document_4482b4e5.js.map